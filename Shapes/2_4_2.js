...
function incrementOrientation(orientation)
{
...
function getShapes()
{
    ...
    shapes.moveByButtonIndex = function (button_index, user_clicked)
    {
        ...
        if(button_index == 0)
        {
            ...
            {
                if(this.location_indices[shape_index] < 3)
                {
                    incrementOrientation(this.orientations[shape_index]);
                }
            }
        }
        else
